...
### Global variables
poc_share = 0.318
poc_support_for_poc_candidates = 0.9779830
poc_support_for_white_candidates = 1-poc_support_for_poc_candidates
white_support_for_poc_candidates = 0.1325795
white_support_for_white_candidates = 1-white_support_for_poc_candidates
num_ballots = 1000
num_simulations = 100
seats_open = 5
